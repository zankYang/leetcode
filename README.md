...
- Registro de las soluciones que voy resolviendo en LeetCode.
...
- Los problemas pueden ser de cualquier dificultad (Fácil, Medio, Difícil) y de cualquier categoría.
...
├── README.md
├── 001-two-sum/
│   ├── Solution.java   # Solución lista para LeetCode
│   ├── Main.java       # Casos de ejemplo locales
│   └── README.md       # Enunciado breve + enfoque + complejidad
├── 002-add-two-numbers/
│   ├── Solution.java
│   ├── ListNode.java   # Auxiliar cuando el problema lo requiere
│   ├── Main.java
│   └── README.md
└── NNN-nombre-del-problema/
    ├── Solution.java
    ├── Main.java
    └── README.md
